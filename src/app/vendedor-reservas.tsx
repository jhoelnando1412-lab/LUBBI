...
export default function VendedorReservas() {
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.titulo}>Reservas Recibidas</Text>
      </View>
      <View style={styles.body}>
        <Text style={styles.icon}>📋</Text>
        <Text style={styles.msg}>Reservas de tus clientes</Text>
        <Text style={styles.sub}>Próximamente podrás ver y gestionar las reservas de tus clientes aquí.</Text>
      </View>
    </View>
  );
}
